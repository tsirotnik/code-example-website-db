...
from nover.tables.dog import Dog
from nover.tables.owner import Owner
from nover.tables.sitter import Sitter
from nover.tables.stay import Stay
...
class DataLoader(object):
    ...
    def __init__(self):
        ...
        # os.system("rm sqlite_db/nover.sqlite")

        # remove database file before loading to start fresh
        if os.path.isfile("sqlite_db/nover.sqlite"):
            print "remove database file before continuing!"
            exit()

        # load schema
        os.system("sqlite3 sqlite_db/nover.sqlite < sqlite_db/schema.sql")
        ...
        try:
            ...
            with open("nover/ingest/reviews.csv", "r") as fh:
